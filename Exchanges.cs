...
namespace CryptoHelper
{
    ...
    {
        const string api = "1c1dJd4pEb0Rz0Rb1p";
        const string apiSecret = "u8rRAkTbfCBqkiR7zIh4Dh9yP6X0RFSM08MH";
    ...
    {
        const string api = "mx0vglXOHNSDgBNmr2";
        const string apiSecret = "def7f4aed44f4300839e3fbc53972a0e";
    ...
    class OKXExchange : Exchange
    {
        ...
        const string api = "60cf94a6-ed4f-421a-98c3-49cc2e0b1b41";
        const string apiSecret = "3130C6D1E16DE78B8EF978454B482EF0";
        public OKXExchange()
        {
    ...
    {
        const string api = "taKDC0YrMg9uSjQJI6gA4rr9fMotGcnRbohpqX1hoAo6Aau4kLPVRy1eoUKis2ARE7c1TJVzybDmGUPAw";
        const string apiSecret = "Ai9WV8sWA7PTztzv3WRoZYc4aQabccF3oluIbrGqx0N1H5XmPTfOzu0RBTOISsLxBGZPtHLI157znzUqN0RQ";
